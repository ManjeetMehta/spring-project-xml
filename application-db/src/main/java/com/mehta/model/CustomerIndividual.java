...
public class CustomerIndividual implements Serializable {
	...
	public CustomerIndividual(Integer id) {
		super();
		this.id = id;
	}

	public CustomerIndividual(Date created, Long createdBy, Date lastModified,
