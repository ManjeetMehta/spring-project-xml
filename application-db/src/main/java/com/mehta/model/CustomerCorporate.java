...
@Entity
@Table(name = "customer_corporate")
public class CustomerCorporate implements Serializable {
	...
	public CustomerCorporate(Integer id) {
		super();
		this.id = id;
	}

	public CustomerCorporate(Date created, Long createdBy, Date lastModified,
